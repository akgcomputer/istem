...
async function onRequestPost(context) {
  try {
    ...
    const batch = data.map((s) => stmt.bind(
      s.id || "s-bulk-" + Date.now() + Math.floor(Math.random() * 1e3),
      s.name || "Yeni Okul",
...
async function onRequestPost2(context) {
  try {
    ...
    `);
    const batch = data.map((c) => stmt.bind(
      c.id || "c-bulk-" + Date.now() + Math.floor(Math.random() * 1e3),
      c.name || "Yeni Kurs",
...
async function onRequestPost3(context) {
  try {
    ...
    `);
    const batch = data.map((t) => stmt.bind(
      t.id || "t-bulk-" + Date.now() + Math.floor(Math.random() * 1e3),
  ...
  "api/challenges/[id].ts"() {
    ...
    onRequestPut = /* @__PURE__ */ __name(async (context) => {
      try {
        ...
        await context.env.DB.prepare(`UPDATE challenges SET ${setClause} WHERE id = ?`).bind(...values, id).run();
    ...
    onRequestDelete = /* @__PURE__ */ __name(async (context) => {
      try {
        const id = context.params.id;
        await context.env.DB.prepare(`DELETE FROM challenges WHERE id = ?`).bind(id).run();
        return new Response(JSON.stringify({ success: true }), { headers: { "Content-Type": "application/json" } });
      } catch (err) {
        return new Response(JSON.stringify({ error: err.message }), { status: 500 });
      }
  ...
  "api/courses/[id].ts"() {
    ...
    onRequestPut2 = /* @__PURE__ */ __name(async (context) => {
      try {
        ...
        await context.env.DB.prepare(`UPDATE courses SET ${setClause} WHERE id = ?`).bind(...values, id).run();
        return new Response(JSON.stringify({ success: true }), { headers: { "Content-Type": "application/json" } });
      } catch (err) {
        return new Response(JSON.stringify({ error: err.message }), { status: 500 });
      }
  ...
  "api/private_schools/[id].ts"() {
    ...
    onRequestPut3 = /* @__PURE__ */ __name(async (context) => {
      try {
        ...
        await context.env.DB.prepare(`UPDATE private_schools SET ${setClause} WHERE id = ?`).bind(...values, id).run();
        return new Response(JSON.stringify({ success: true }), { headers: { "Content-Type": "application/json" } });
      } catch (err) {
        return new Response(JSON.stringify({ error: err.message }), { status: 500 });
      }
  ...
  "api/special_courses/[id].ts"() {
    ...
    onRequestPut4 = /* @__PURE__ */ __name(async (context) => {
      try {
        ...
        await context.env.DB.prepare(`UPDATE special_courses SET ${setClause} WHERE id = ?`).bind(...values, id).run();
        return new Response(JSON.stringify({ success: true }), { headers: { "Content-Type": "application/json" } });
      } catch (err) {
        return new Response(JSON.stringify({ error: err.message }), { status: 500 });
      }
    ...
    onRequestDelete4 = /* @__PURE__ */ __name(async (context) => {
      try {
        const id = context.params.id;
        await context.env.DB.prepare(`DELETE FROM special_courses WHERE id = ?`).bind(id).run();
        return new Response(JSON.stringify({ success: true }), { headers: { "Content-Type": "application/json" } });
      } catch (err) {
        return new Response(JSON.stringify({ error: err.message }), { status: 500 });
      }
  ...
  "api/teachers/[id].ts"() {
    ...
    onRequestPut5 = /* @__PURE__ */ __name(async (context) => {
      try {
        ...
        await context.env.DB.prepare(`UPDATE teachers SET ${setClause} WHERE id = ?`).bind(...values, id).run();
        return new Response(JSON.stringify({ success: true }), { headers: { "Content-Type": "application/json" } });
      } catch (err) {
        return new Response(JSON.stringify({ error: err.message }), { status: 500 });
      }
    }, "onRequestPut");
    onRequestDelete5 = /* @__PURE__ */ __name(async (context) => {
      try {
        const id = context.params.id;
        await context.env.DB.prepare(`DELETE FROM teachers WHERE id = ?`).bind(id).run();
        return new Response(JSON.stringify({ success: true }), { headers: { "Content-Type": "application/json" } });
      } catch (err) {
        return new Response(JSON.stringify({ error: err.message }), { status: 500 });
      }
      ...
      try {
        ...
        const categories = results.map((cat) => {
          if (typeof cat.topSkills === "string") {
            try {
              cat.topSkills = JSON.parse(cat.topSkills);
            } catch (e) {
              cat.topSkills = [];
            }
      ...
      try {
        ...
        const employees = results.map((emp) => {
          if (typeof emp.assignedCourses === "string") {
            try {
              emp.assignedCourses = JSON.parse(emp.assignedCourses);
            } catch (e) {
              emp.assignedCourses = [];
            }
          ...
          if (typeof emp.progress === "string") {
            try {
              emp.progress = JSON.parse(emp.progress);
            } catch (e) {
              emp.progress = {};
            }
...
var init_web = __esm({
  "../node_modules/@google/genai/dist/web/index.mjs"() {
    ...
    __name(codeExecutionResultToVertex$3, "codeExecutionResultToVertex$3");
    ...
    __name(executableCodeToVertex$3, "executableCodeToVertex$3");
    ...
    __name(codeExecutionResultToVertex$2, "codeExecutionResultToVertex$2");
    __name(contentToMldev$2, "contentToMldev$2");
    __name(contentToVertex$2, "contentToVertex$2");
    __name(executableCodeToVertex$2, "executableCodeToVertex$2");
    ...
    __name(codeExecutionResultToVertex$1, "codeExecutionResultToVertex$1");
    ...
    __name(executableCodeToVertex$1, "executableCodeToVertex$1");
...
${underline}`);
    ...
    BaseAgents = class extends APIResource {
      static {
        __name(this, "BaseAgents");
      }
      /**
    ...
    Agents = class extends BaseAgents {
      static {
        __name(this, "Agents");
      }
    };
    ...
    __name(isLegacyLyriaRequest, "isLegacyLyriaRequest");
    __name(isVertexClient, "isVertexClient");
    __name(isPlainObject, "isPlainObject");
    __name(wrapOutputsAsSteps, "wrapOutputsAsSteps");
    __name(coerceLegacyInteractionResponse, "coerceLegacyInteractionResponse");
    __name(maybeRemapLegacyStreamEvent, "maybeRemapLegacyStreamEvent");
    LegacyLyriaStream = class _LegacyLyriaStream extends Stream {
      static {
        __name(this, "LegacyLyriaStream");
      }
      static fromSSEResponse(response, controller, client) {
        const base = Stream.fromSSEResponse(response, controller, client);
        function wrappedIterator() {
          return __asyncGenerator(this, arguments, /* @__PURE__ */ __name(function* wrappedIterator_1() {
            var _a2, e_1, _b, _c;
            try {
        ...
        __name(wrappedIterator, "wrappedIterator");
    ...
    BaseWebhooks = class extends APIResource {
      static {
        __name(this, "BaseWebhooks");
      }
      /**
    ...
    Webhooks = class extends BaseWebhooks {
      static {
    ...
    __name(codeExecutionResultToVertex, "codeExecutionResultToVertex");
    ...
    __name(executableCodeToVertex, "executableCodeToVertex");
      ...
      try {
        ...
        const specialCourses = results.map((course) => {
          if (typeof course.classes === "string") {
            try {
              course.classes = JSON.parse(course.classes);
            } catch (e) {
              course.classes = [];
            }
  ...
  "api/teachers/index.ts"() {
    ...
    onRequestGet9 = /* @__PURE__ */ __name(async (context) => {
      try {
        ...
        const formattedResults = teachers.map((row) => {
          const teacherSessions = sessions.filter((s) => s.teacherId === row.id).map((s) => ({
            name: s.name,
            price: s.price,
            duration: "60 dk",
            courseId: s.courseId
