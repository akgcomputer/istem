...
import { MOCK_SPECIAL_COURSES, SpecialCourse } from '../data/catalogData';
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex flex-col gap-1.5">
                  {[
                    ...
                    { value: 'Sanat ve Müzik', label: '🎭 Sanat ve Müzik Kursları' },
                    { value: 'Spor ve Fitness', label: '🏋️ Spor ve Fitness Kursları' },
                    { value: 'El Sanatları', label: '🧵 El Sanatları ve Üretim' },
                    { value: 'Mesleki Sertifika', label: '📜 Mesleki Sertifika Kursları' }
                  ].map(opt => (
                    <button
                      key={opt.value}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Sanat ve Müzik">🎭 Sanat ve Müzik Kursları</option>
                      <option value="Spor ve Fitness">🏋️ Spor ve Fitness Kursları</option>
                      <option value="El Sanatları">🧵 El Sanatları ve Üretim</option>
                      <option value="Mesleki Sertifika">📜 Mesleki Sertifika Kursları</option>
                    </select>
                  </div>
                </div>
