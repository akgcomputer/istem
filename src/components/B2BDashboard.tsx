    ...
    <div className="bg-[#FAF9F5] min-h-screen py-6 sm:py-10 text-zinc-900 border-t border-zinc-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border border-zinc-200/60 rounded-3xl p-6 sm:p-8 mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6 shadow-xs">
          <div>
            <span className="text-[10px] tracking-widest font-black text-[#FF6600] uppercase block mb-1">KURUMSAL B2B PORTALI</span>
            <h1 className="text-2xl sm:text-3xl font-extrabold font-display text-zinc-950 mt-1 flex items-center gap-2">
              <Building2 className="w-8 h-8 text-[#FF6600] shrink-0" /> İK &amp; Şirket Yönetim Paneli
            </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0">
            <div className="bg-[#FAF9F5] border border-[#FF6600]/20 p-4 rounded-xl flex items-center gap-3">
              <div className="w-10 h-10 bg-[#FF6600]/10 text-[#FF6600] rounded-xl flex items-center justify-center shrink-0">
              ...
              <div className="text-left">
                ...
                <span className="text-[10px] font-semibold text-zinc-500 block">Temsilci: <strong className="text-[#FF6600] font-extrabold">{representativeName}</strong></span>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            <div className="bg-white border border-zinc-200/65 rounded-3xl p-6 shadow-3xs text-left">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-zinc-100 pb-4 mb-4">
                <div>
                  <h3 className="text-base font-black text-zinc-950 flex items-center gap-2">
                    <FilePlus className="w-5 h-5 text-[#FF6600]" /> Toplu Eğitim Talep Bölümü
                  </h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="md:col-span-2 space-y-1">
                      ...
                      <input 
                        ...
                        className="w-full bg-white border border-zinc-100 rounded-xl px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-[#FF6600] font-bold text-zinc-800 placeholder-zinc-400"
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input 
                        ...
                        className="w-full bg-white border border-zinc-100 rounded-xl px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-[#FF6600] font-bold text-zinc-800"
                      />
                    </div>
                          ...
                          return (
                            <button
                              ...
                              className={`px-3 py-2 text-xs font-black rounded-lg border transition select-none cursor-pointer ${
                                isSelected
                                  ? 'bg-[#FF6600] text-white border-[#FF6600] shadow-md ring-2 ring-amber-300 scale-105 font-black'
              ...
              <div className="mt-5 pt-4 border-t border-zinc-100">
                <span className="text-[10px] font-extrabold text-[#FF6600] tracking-wider block uppercase mb-3.5">Toplu Eğitim Talep Edilen Eğitimler</span>
              ...
              <form onSubmit={handleAddCampaign} className="bg-[#FAF9F5] border border-zinc-200 p-4 rounded-2xl space-y-4">
                      ...
                      return (
                        <button
                          ...
                          className={`text-left p-2 rounded-lg text-xs border font-bold transition flex items-center justify-between cursor-pointer ${
                            isSelected 
                              ? 'bg-[#FF6600]/10 text-[#FF6600] border-[#FF6600]' 
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white border border-zinc-200 rounded-xl px-3 py-2 text-xs focus:ring-1 focus:ring-[#FF6600] focus:outline-none placeholder-zinc-400 text-zinc-800 font-bold"
                  />
                </div>
            ...
            <div className="bg-white border border-zinc-200/60 rounded-3xl p-5 shadow-xs">
              <h3 className="text-base font-black text-zinc-950 mb-4 flex items-center gap-1.5 border-b border-zinc-100 pb-3">
                <GraduationCap className="w-5 h-5 text-[#FF6600]" /> Eğitim Programlarım (Kurumsal İlerleme Listesi)
              </h3>
                        ...
                        <td className="py-3.5 px-4 text-center">
                          {record.status === 'Bitti' ? (
                            <button
                              ...
                              className="bg-zinc-100 hover:bg-[#FF6600]/10 text-emerald-700 hover:text-[#FF6600] p-2 rounded-lg transition border border-zinc-200 cursor-pointer inline-flex items-center justify-center gap-1.5"
            ...
            <div className="bg-white border border-zinc-200/60 rounded-3xl p-5 shadow-xs flex flex-col h-full text-left">
              <div className="border-b border-zinc-100 pb-3 mb-4">
                <span className="inline-flex items-center gap-1 bg-amber-50 border border-amber-200 px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider text-[#FF6600] mb-1.5">
                  <Sparkles className="w-3 h-3 text-[#FF6600] animate-pulse" /> Kurumsal Fırsatlar
                </span>
          ...
          <div className="bg-[#FAF9F5] border border-zinc-200 rounded-3xl w-full max-w-lg p-6 relative shadow-2xl animate-fade-in text-center">
            ...
            <div className="bg-white border border-zinc-150 p-4 rounded-xl flex items-center justify-center gap-4 mb-4">
              ...
              <div className="text-left font-semibold">
                <span className="text-[10px] text-[#FF6600] font-black block">KAREKOD GÜVENLİK ANALİZİ</span>
